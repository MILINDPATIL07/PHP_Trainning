...
<!-- online link BS -->
		...
		<style type="text/css">
			...
			#border{ box-shadow:0px 0px 3px gray;
				margin-top:30px;
				margin-bottom:30px;}
			i.fa{color:#b4a306;}
			b{color: #1ae646;}
			/* .abc{background-image: url("bgimg.jpg");background-repeat: repeat; height: 100%;} */
    ...
    <body>
    <form action="update.php" method="get"name="register">
