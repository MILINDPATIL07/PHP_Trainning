                ...
                <div class="abc col-lg-offset-4 col-lg-4 col-md-offset-4 col-md-4 col-sm-offset-4 col-sm-6 col-xs-12" id="border">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input id="fn" type="text" name="name" placeholder="Enter Your First Name" maxlength="20" class="form-control" value="<?php echo $row['fname'] ?>" autofocus required />
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                            <input id="ln" type="text" name="name1" placeholder="Enter Your Last Name " maxlength="20" class="form-control" value="<?php echo $row['lname'] ?>" autofocus required />
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input id="cn" type="text" name="MobileNo" placeholder="Enter Your contact no. " maxlength="10" class="form-control" value="<?php echo $row['mobile'] ?>" autofocus required />
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input id="TxtPassword" name="password" type="password" placeholder="Enter Your password" maxlength="12" class="form-control" value="<?php echo $row['password'] ?>" autofocus />
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-envelope"></i></span>
                            <input type="file" name="fileToUpload" class="form-control" value="<?php echo $row['file'] ?>" />
                            <div id=""></div>
                        </div>
