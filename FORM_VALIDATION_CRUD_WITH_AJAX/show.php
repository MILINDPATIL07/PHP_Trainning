    ...
    <table border="1" width="100%">
        ...
        ?>
                <tr>
                    ...
                    <td><a href="delete.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure want to delete?')" title="delete">Delete</a></td>
                    <!-- delete with ajax  -->
                    <td><a href="" onclick="deletere(<?php echo $row['id']; ?>)" title="delete">ADelete</a></td>
                </tr>
        <?php
            }
        } else {
