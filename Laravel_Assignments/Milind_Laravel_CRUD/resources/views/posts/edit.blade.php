    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="fname" value="{{ $post->fname }}" class="form-control"
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="lname" value="{{ $post->lname }}" class="form-control"
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <select name="designation" class="form-control">
                    ...
                    <option value="Trainee"{{ ($post->designation=="Trainee")? "selected" : "" }}>Trainee</option>
                    ...
                    <option value="Associate Software Devloper"{{ ($post->designation=="Associate Software Devloper")? "selected" : "" }}>Associate Software Devloper</option>
                    <option value="Business analytics" {{ ($post->designation=="Business analytics")? "selected" : "" }}> Business analytics</option>
                </select>
